...
void satellite(){
	...
	//body
	glPushMatrix();
	glColor3f(1.0,0.0,0.0); // Red color in satellite body
	glScaled(1,0.6,1);
	...
	glPushMatrix();
	glColor3f(0.0,1.0,0.0); // Green color in satellite panels
	...
	glPushMatrix();
	glColor3f(1.0,0.0,0.0); // Red color in top part of satellite
	...
	glPushMatrix();
	glColor3f(1.0,0.0,0.0); // Red color in bottom part of satellite
	glTranslatef(3.0,0,0.4);
...
void sat1(){
	...
	//Moon
	glPushMatrix();
	glColor3f(1,1,1); // set white color for moon
...
void display()
{
	...
	stroke_output(-2.0, 1.7, "Press S--> To Start");
	stroke_output(-2.0, 0.9, "Press T--> To Transmit");
	stroke_output(-2.0, 0.0, "Press Q--> To Quit");
...
int main(int argc, char *argv[])
{
    ...
    glutCreateWindow("Working Procedure of a Satellite");
